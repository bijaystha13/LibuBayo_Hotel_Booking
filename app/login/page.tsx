...
//         }, 2000);
//       } else {
//         // Login request - NO Authorization header needed for login
//         responseData = await sendRequest(
...
// app/login/page.tsx - SERVER COMPONENT (default)
import LoginPage from "./components/LoginPage";
import { Metadata } from "next";

export const metadata: Metadata = {
  title: "Login | LuxeStay",
  description: "Login to your LuxeStay account",
};
